...
-- True
list1 :: forall a. Parser a -> Parser (List a)
-- list1 pa = appendRest =<< pa
--   where 
--     appendRest :: a -> Parser (List a)
--     appendRest a = (a :.) <$> list pa
list1 pa = (:.) <$> pa <*> list pa
...
--   spaces1
--   phone <- phoneParser
--   pure (Person age firstname surname smoke phone)
