...
seqOptional = foldRight seqOptional' (Full Nil)

seqOptional' :: Optional a -> Optional (List a) -> Optional (List a)
seqOptional' Empty _ = Empty
seqOptional' (Full _) Empty = Empty
seqOptional' (Full a) (Full Nil) = Full (a :. Nil)
seqOptional' (Full a) (Full as) = Full (a :. as)
